...
export default class Xiangqing extends Component {
    ...
    change = (e) => {
      ...
      tijiao = () => {
        ...
        fetch('http://localhost:9000/pinglun', {
          method: 'POST',
          mode: "cors",
    ...
    //     };
      shoucang = () => {
        if (this.state.sc == "收藏") {
          fetch('http://localhost:9000/shoucang', {
            method: 'POST',
            mode: "cors",
            headers: { 'Content-Type': 'application/json; charset=utf-8' },
            body: JSON.stringify({
          ...
          fetch('http://localhost:9000/quxiaosc', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json; charset=utf-8' },
            body: JSON.stringify({
              bname: this.state.bname
      ...
      componentWillMount() {
        ...
        fetch('http://localhost:9000/pinglunxs', {
        method: 'POST',
        mode: "cors",
        headers: { 'Content-Type': 'application/json; charset=utf-8' },
        body: JSON.stringify({
        ...
        fetch('http://localhost:9000/pdshoucang', {
          method: 'POST',
          headers: { 'Content-Type': 'application/json; charset=utf-8' },
          body: JSON.stringify({
            bname: this.state.bname,
        ...
        setTimeout(function(){
            if (!arr.length) {
                ...
                fetch('http://localhost:9000/historyadd',{
                    method:'POST',
                    body:JSON.stringify({title:arr[5],name:arr[6],press:arr[7],isbn:arr[8],img:arr[0],herf:brr,user:lastname}),
                    headers:{"Content-Type":"application/json"}
                }).then(res => res.text())
                .then(res =>{
                    console.log('success')
            ...
            <div className="header2">
                ...
                <div className="bk">    
                    <div style={{"height":"250px","width":"170px"}}>
                        <img src={require('../images/30.jpg')} style={{height:'210px'}}></img>
                    </div>
...
//     componentDidMount() {
//         console.log(this.props.location.state.name);var data = this.props.location.state.name;
//         this.setState({data:data})
...
//                     <div style={{"backgroundColor":"lightgray","height":"30px","width":"15%","textAlign":"center"}} onClick={this.onclick1}>
