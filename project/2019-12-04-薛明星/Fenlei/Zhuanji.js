...
export default class Zhuanji extends Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        fetch("http://localhost:9000/index",{
            method: 'POST', // or 'PUT'
            body:JSON.stringify({name:encodeURI('传记')}), // data can be `string` or {object}!
            headers: 
           ...
           <div className="header1">
                ...
                <div className="content">
                    ...
                    this.state.totaldata.map(function(name){
                        return(
                        <li key={name.id}>
                            <Link to={{pathname:'/shouye/fenlei/zhuanji/xiangqing',state:{name:name.herf}} }>
