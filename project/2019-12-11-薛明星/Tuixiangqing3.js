...
export default class Tuixiangqing1 extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      bname:'《房思琪的初恋乐园》',
      sctime:'',
      tuurl: 'https://img3.doubanio.com/view/subject/l/public/s29651121.jpg',
      sc:'收藏',
      author:'林奕含',
      name: '',
      content: '',
        ...
        <div className="jianjie">
          <ul>
            <li>
              ...
              <div><p style={{"paddingTop": "10px",textIndent:'2em'}}>《失踪的孩子》是“那不勒斯四部曲”的第四部，小 说聚焦了莉拉和埃莱娜（“我”）的壮年和晚年，为她们持续了五十多年的友谊划上了一个令人心碎的句号。</p></div>
            </li>
            <li>
